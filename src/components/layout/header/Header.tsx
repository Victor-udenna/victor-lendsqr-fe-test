...
const Header = () => {
  ...
  return (
    <header className="header">
      <div className="header-item__left mobile-hidden">
        <img width={144.8} src={logoImg} alt="logo" />

        <div className="input-search__container mobile-hidden">
          <input placeholder="Search for anything" className="search-input" type="text" />
      ...
      <div className="header-item__right">
        <p className="mobile-hidden">Docs</p>
        <Button className="mobile-hidden">
          <img width={26} height={26} src={notificationIcon} />
        </Button>
        <div className="header-item__userprofile">
          <img alt="userImg" className="user-img" width={48} height={48} src={avatarImg} />
          <p>Adedeji</p>
          <img alt="userImg" className="user-img" width={20} height={20} src={arrowDown} />
        </div>
      </div>
